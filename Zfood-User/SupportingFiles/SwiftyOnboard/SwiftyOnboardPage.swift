...
open class SwiftyOnboardPage: UIView {
    ...
    func setUp() {
        ...
        imageView.topAnchor.constraint(equalTo: margin.topAnchor, constant: 80).isActive = true
        ...
        subTitle.leftAnchor.constraint(equalTo: margin.leftAnchor, constant: 40).isActive = true
        subTitle.rightAnchor.constraint(equalTo: margin.rightAnchor, constant: -40).isActive = true
